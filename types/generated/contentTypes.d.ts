...
export interface ApiContactFormContactForm extends Schema.SingleType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::contact-form.contact-form', 'oneToOne', 'admin::user'> &
      Attribute.Private;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    title: Attribute.String;
    slug: Attribute.String;
    subcategory: Attribute.Component<'small-component.subcategory', true> & Attribute.Required;
    category: Attribute.Component<'small-component.category', true> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
